...
// Explicit SVGProps interface, now including color:
...
const SVGComponent: React.FC<SVGProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M17.5 6H11.5C10.9477 6 10.5 6.44772 10.5 7V9C10.5 9.55228 10.9477 10 11.5 10H17.5C18.0523 10 18.5 9.55228 18.5 9V7C18.5 6.44772 18.0523 6 17.5 6Z"
        stroke={color}
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
