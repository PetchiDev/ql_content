...
// Add an explicit interface to support color prop
interface SVGProps extends React.SVGProps<SVGSVGElement> {
  color?: string;
}

const SVGComponent: React.FC<SVGProps> = (props) => {
  // Use color prop or default to gray (#646464)
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M6.5 5C9 5 11 7 11 9.5V17C11 17.5304 10.7893 18.0391 10.4142 18.4142C10.0391 18.7893 9.53043 19 9 19"
        stroke={color}
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
