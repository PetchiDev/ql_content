...
const LinkedInIcon = ({ size = 32, isMobile = false }: LocationIconProps) => {
  return (
    <SvgIcon style={{ width: size, height: size }}>
      {isMobile ? (
        ...
        >
          ...
          <path
            d="M24.0007 7.2002H8.99917C8.6546 7.2002 8.32414 7.33708 8.08048 7.58073..."
            fill="white"
          />
        </svg>
      ) : (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <rect x={2} y={2} width={28} height={28} rx={6} fill="#1275B1" />
          <path
